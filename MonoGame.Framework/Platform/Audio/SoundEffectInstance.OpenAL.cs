...
#region Initialization
        ...
        internal void PlatformSetFilter(FilterMode mode, float filterQ, float frequency)
        {
            ...
            case FilterMode.BandPass:
                filterType = FilterType.Bandpass;//EfxFilterType.Bandpass;
                break;
            case FilterMode.LowPass:
                filterType = FilterType.Lowpass; //EfxFilterType.Lowpass;
                break;
            case FilterMode.HighPass:
                filterType = FilterType.Highpass;//EfxFilterType.Highpass;
                break;
            }
