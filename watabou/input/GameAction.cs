...
{
    // libgdx 
    // libgdx-master\gdx\src\com\badlogic\gdx\Input.java
    public class Keys
    {
    ...
    {
        private static List<GameAction> ALL_ACTIONS = new List<GameAction>();
        ...
        {
            //return o is GameAction && ((GameAction)o).code == code;
        ...
        public static GameAction NONE = new GameAction("none");
        public static GameAction BACK = new GameAction("back");

        public static List<GameAction> AllActions()
        {
            return new List<GameAction>(ALL_ACTIONS);
        }

        public static int TotalActions()
        {
            return ALL_ACTIONS.Count;
        }
    }
}
